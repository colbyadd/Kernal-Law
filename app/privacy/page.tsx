    ...
    return (
        <main className="bg-iron-950 min-h-screen">
            ...
            <div className="container mx-auto px-6 py-12 text-silver-400 max-w-4xl space-y-8 leading-relaxed">
                ...
                <h2 className="text-2xl text-white font-serif">3. Communications &amp; Text Messaging</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">4. Data Security</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">5. Third-Party Services</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">6. Cookies &amp; Tracking</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">7. Your Rights</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">8. Children&rsquo;s Privacy</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">9. Changes to This Policy</h2>
                <p>
                ...
                <h2 className="text-2xl text-white font-serif">10. Contact Us</h2>
                <p>
