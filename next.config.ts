...
const contentSecurityPolicy = [
  ...
  "media-src 'self'",
  "connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com" + (isDevelopment ? " http: https: ws: wss:" : ""),
